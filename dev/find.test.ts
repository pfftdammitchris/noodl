...
describe(`Find`, () => {
  it(`should get called on every key encountered`, () => {
    
  })
})

export function getLogoutPageObj() {
  return {
    "Logout": {
      "module": "patient",
      "pageNumber": "65",
          ...
          "children": [
            ...
            },
            {
              ...
              "children": [
                {
                  "type": "label",
                  "text": "It is important to remember your password, since we cannot recover it on blockchain",
                  "style": {
                    "color": "0x00000058",
                    "left": "0.04",
                    "top": "0.02",
