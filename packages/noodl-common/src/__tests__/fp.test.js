...
const assign_1 = require("../fp/assign");
const nc = require("..");
describe.only(nc.coolGold('fp'), () => {
    ...
    describe(nc.italic(`Object -> YAMLMap`), () => {
        it.only(`should behave like Object.assign`, () => {
            ...
            let emitMap = new yaml_1.default.YAMLMap();
            let objResult = assign_1.default(emitObject, assign_1.default(gotoObject, mock.getButtonComponent()), { goto: assign_1.default({ variant: 1 }, mock.getBuiltInAction('redraw')) });
