...
class Transformer {
    ...
    get transform() {
        return __classPrivateFieldGet(this, _Transformer_transducer, "f");
    }
    compose(...transforms) {
        ...
        return flowRight(...transforms.map(wrapExecute))((node) => node);
    }
    createTransform(fn) {
        if (this.transforms.includes(fn))
            return this;
        this.transforms.push(fn);
        __classPrivateFieldSet(this, _Transformer_transducer, this.compose(...this.transforms), "f");
        return this;
    }
}
