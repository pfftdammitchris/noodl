...
export interface EvalActionObject extends ActionObject, Pick<UncommonActionObjectProps, 'dataKey' | 'dataObject'> {
    ...
    object?: OrArray<IfObject | BuiltInEvalObject | BuiltInActionObject | GotoObject<string | {
        dataIn?: DataIn;
    }> | '' | Record<ReferenceString, null | boolean | BuiltInEvalObject | LiteralUnion<ReferenceString, string> | number | string | Record<ReferenceString, ReferenceString>>>;
    [key: string]: any;
}
export interface OpenCameraActionObject extends ActionObject, Pick<UncommonActionObjectProps, 'dataKey' | 'dataObject'> {
    actionType: 'openCamera';
    [key: string]: any;
}
export interface OpenPhotoLibraryActionObject extends ActionObject, Pick<UncommonActionObjectProps, 'dataKey' | 'dataObject'> {
    actionType: 'openPhotoLibrary';
    [key: string]: any;
}
export interface OpenDocumentManagerActionObject extends ActionObject, Pick<UncommonActionObjectProps, 'dataKey' | 'dataObject'> {
